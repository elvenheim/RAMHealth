<?php 
    ...
    $csvData = "air_quality_table_id,air_quality_room_num,aq_gas_id,aq_indoor_temp_id,aq_outdoor-temp_id, aq_pm_id, aq_humidity_id" . PHP_EOL; //you may change your table headers
    ...
    for ($i = 1; $i <= 11; $i++) {
        ...
        $csvData .= "$i,$roomNumber,$sensor_gas,$sensor_indoor_temp,$sensor_outdoor_temp,$sensor_pm,$sensor_humidity" . PHP_EOL; //row data generator
    }
