...
<head>
    ...
    <link rel="stylesheet" href="../Air Quality Technician/AQ Tech Design/Parameters/aq_content_relative_humid.css">
    ...
    <body class="aq-technician-main">
        ...
        <div class="content"> 
            ...
            <div id="relative-humidity-param-table" class="relative-humidity-parameter">
                <div class="card">
                    <div class = "table-button">
                        ...
                        <form class="import-table" method="POST" enctype="multipart/form-data" action="../scripts/import_table_aq.php">
                            <label class="import-btn">
                                ...
                                <input type="hidden" id="table_name" name="table_name" value="aq_relative_humidity">
                    ...
                    <table id = 'relative-humidity-parameters-table' class = 'relative-humidity-table'>
                        <thead>
                            <tr>
                                <th><a href="#arrange-room-number" onclick="sortAQHumidityTable(0)">Room Number<span class="sort-indicator">&#x25BC;</span></a></th>
                                <th><a href="#arrange-sensor-id" onclick="sortAQHumidityTable(1)">Sensor ID<span class="sort-indicator">&#x25BC;</span></a></th>
                                <th><a href="#arrange-sensor-name" onclick="sortAQHumidityTable(2)">Sensor Name<span class="sort-indicator">&#x25BC;</span></a></th>
                                <th><a href="#arrange-date" onclick="sortAQHumidityTable(3)">Date<span class="sort-indicator">&#x25BC;</span></a></th>
                                <th><a href="#arrange-time" onclick="sortAQHumidityTable(4)">Time<span class="sort-indicator">&#x25BC;</span></a></th>
                                <th><a href="#arrange-relative-humidity" onclick="sortAQHumidityTable(5)">Relative Humidity<span class="sort-indicator">&#x25BC;</span></a></th>
                            </tr>
                        </thead>
                        <tbody id = 'table-body'>
                            <?php include 'air_technician_relative_humidity.php'?>
                        </tbody>
                    </table>
                    <?php include '../Air Quality Technician/AQ Tech Design/AQ Tech Pagination/relative_humid_pagination.php'; ?>
                </div>
            </div>
        </div>
    </body>
