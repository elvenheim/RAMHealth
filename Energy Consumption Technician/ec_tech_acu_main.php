		...
		<div id="acu-param-table" class="acu-parameter">
			<div class="card">
				<div class = "table-button">
					...
					<button id="download-table" class="download-table" onclick="downloadACUExcelTable()">
                        <span class="fas fa-download"></span> Export </button>
				</div>
				<table id = 'acu-parameters-table' class = 'acu-table'>
					<thead>
						<tr>
							<th><a href="#arrange-floor" onclick="sortACUTable(0)">Floor<span class="sort-indicator">&#x25BC;</span></a></th> 
							<th><a href="#arrange-room-number" onclick="sortACUTable(1)">Room Number<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-sensor-id" onclick="sortACUTable(2)">Sensor ID<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-date" onclick="sortACUTable(3)">Date<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-time" onclick="sortACUTable(4)">Time<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-current" onclick="sortACUTable(5)">Current<span class="sort-indicator">&#x25BC;</span></a></th>
						</tr>
					</thead>
					<tbody id = 'table-body'>
						<?php include '../Energy Consumption Technician/tables/parameters/acu_table.php'?>
					</tbody> 
				</table>
				<?php include '../Energy Consumption Technician/EC Tech Design/Pagination/acu_pagination.php'; ?>
			</div>
		</div>
    </div>
</body>
