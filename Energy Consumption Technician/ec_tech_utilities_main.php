...
<head>
	...
	<link rel="stylesheet" href="../Energy Consumption Technician/EC Tech Design/Parameters/ec_content_utilities.css">
...
<body class="ec-technician-main">
	...
	<div class="content">
		...
		<div id="utilities-param-table" class="utilities-parameter">
			<div class="card">
				...
				<table id = 'utilities-parameters-table' class = 'utilities-table'>
					<thead>
						<tr>
