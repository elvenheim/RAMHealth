...
<head>
	...
	<link rel="stylesheet" href="../Energy Consumption Technician/EC Tech Design/Parameters/ec_content_outlet.css">
...
<body class="ec-technician-main">
	...
	<div class="content">
		...
		<div id="outlet-param-table" class="outlet-parameter">
			<div class="card">
