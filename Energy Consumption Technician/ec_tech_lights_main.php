		...
		<div id="acu-param-table" class="acu-parameter">
			<div class="card">
				<div class = "table-button">
					...
					<button id="download-table" class="download-table" onclick="downloadLightsExcelTable()">
                        <span class="fas fa-download"></span> Export </button>
				</div>
				<table id = 'lights-parameters-table' class = 'lights-table'>
					<thead>
						<tr>
							<th><a href="#arrange-floor" onclick="downloadLightsExcelTable(0)">Floor<span class="sort-indicator">&#x25BC;</span></a></th> 
							<th><a href="#arrange-room-number" onclick="downloadLightsExcelTable(1)">Room Number<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-sensor-id" onclick="downloadLightsExcelTable(2)">Sensor ID<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-date" onclick="downloadLightsExcelTable(3)">Date<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-time" onclick="downloadLightsExcelTable(4)">Time<span class="sort-indicator">&#x25BC;</span></a></th>
                            <th><a href="#arrange-current" onclick="downloadLightsExcelTable(5)">Current<span class="sort-indicator">&#x25BC;</span></a></th>
						</tr>
					</thead>
					<tbody id = 'table-body'>
						<?php include '../Energy Consumption Technician/tables/parameters/lights_table.php'?>
					</tbody> 
				</table>
				<?php include '../Energy Consumption Technician/EC Tech Design/Pagination/lighting_pagination.php'; ?>
			</div>
		</div>
    </div>
</body>
