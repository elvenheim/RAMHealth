<?php     
    ...
    if (isset($_POST['room_number'])) {
        ...
        while ($row = mysqli_fetch_assoc($result_table)){
            $pm_two_five_level[] = $row['pm_two_five'];
        }
    }
?>
...
<body>
    <span class="gauge-title">Particulate Matter 2.5 (Latest)</span>
    <div id="pm-two-five-gauge" class="gauge"></div>
    <script>
        $(document).ready(function() {
            // Configuration options for the gauge
            var gaugeConfig = {
                id: 'pm-two-five-gauge',
                value: '<?php echo isset($pm_two_five_level[0]) ? $pm_two_five_level[0] : 0 ; ?>',
                symbol: ' µg/m³',      
